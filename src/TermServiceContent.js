            ...
            <Container fluid className="termservice-section landing-page-bg d-flex align-items-center">
                <Row className='justify-content-center align-items-center'>
                    ...
                    <Col xs={12} md={8}>
                        ...
                        <h3 className="section-sub-title">General Use</h3>
                        ...
                        <h3 className="section-sub-title">Creating an Account</h3>
                        ...
                        <h3 className="section-sub-title">Communication</h3>
                        ...
                        <h3 className="section-sub-title">Creating and Selling Content/Seller Accounts</h3>
                        ...
                        <h3 className="section-sub-title">Commissions</h3>
                        ...
                        <h3 className="section-sub-title">Payments to You</h3> 
                        ...
                        <h3 className="section-sub-title">Ownership of Your Content</h3>
                        ...
                        <h3 className="section-sub-title">License to Use Your Content</h3>
                        ...
                        <h3 className="section-sub-title">Third Party Content</h3>
                        ...
                        <h3 className="section-sub-title">Our Tools and Content</h3>
                        ...
                        <h3 className="section-sub-title">Acceptable Use of the Service and Restrictions</h3>
                        ...
                        <h3 className="section-sub-title">Original Content Warranties and Representations</h3>
                        ...
                        <h3 className="section-sub-title">Indemnity to Us</h3>
                        <p className="text-white">You agree to indemnify us and our affiliates, employees, officers and directors, and hold us and them harmless from and against any and all damages, claims, costs or expenses, including our attorney’s fees and costs, arising out of or connected with Your Content, use of the Service and/or your breach any warranty, representation or promise made in this User Agreement.</p>
                        

                        <h3 className="section-sub-title">Account Suspension and Termination</h3>
                        ...
                        <h3 className="section-sub-title">Accuracy of Information</h3>
                        ...
                        <h3 className="section-sub-title">Legal Terms</h3>
                        <h3 className="section-sub-title">Warranty Disclaimer</h3>
                        ...
                        <h3 className="section-sub-title">Limitation of Liability</h3>
                        ...
                        <h3 className="section-sub-title">Total Liability</h3>
                        ...
                        <h3 className="section-sub-title">Taxes</h3>
                        ...
                        <h3 className="section-sub-title">Severability, Reformation</h3>
                        ...
                        <h3 className="section-sub-title">Assignment</h3>
                        ...
                        <h3 className="section-sub-title">Relationship of the Parties</h3>
                        ...
                        <h3 className="section-sub-title">Entire Agreement</h3>
                        ...
                        <h3 className="section-sub-title">Modification and Updates</h3>
                        ...
                        <h3 className="section-sub-title">Governing Law</h3>
                        ...
                        <h3 className="section-sub-title">Waiver of Jury Trial</h3>
                        ...
                        <h3 className="section-sub-title">Waiver of Class Action</h3>
                        ...
                        <h3 className="section-sub-title">Limitation on Legal Action</h3>
                        ...
                        <h3 className="section-sub-title">Feedback</h3>
